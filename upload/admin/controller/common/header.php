...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_consignment'] = $this->language->get('text_consignment');
		$this->data['text_abx_consignment'] = $this->language->get('text_abx_consignment');
		$this->data['text_abx_consignment_setting'] = $this->language->get('text_abx_consignment_setting');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['abx_consignment_setting'] = $this->url->link('consignment/settings', 'token=' . $this->session->data['token'], 'SSL');
		}
