...
<div id="container">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="consignment"><a href="<?php echo $consignment; ?>" class="top"><?php echo $text_consignment; ?></a>
        <ul>
          <li><a href="<?php echo $abx_consignment_setting; ?>"><?php echo $text_abx_consignment_setting; ?></a></li>
        </ul>
      </li>
